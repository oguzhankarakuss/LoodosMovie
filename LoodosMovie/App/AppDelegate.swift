...
extension AppDelegate : MessagingDelegate {
    ...
    func messaging(_ messaging: Messaging, didReceiveRegistrationToken fcmToken: String) {
        ...
        Messaging.messaging().subscribe(toTopic: "movie")
        Messaging.messaging().subscribe(toTopic: "movie-ios")
        #if DEBUG
        Messaging.messaging().subscribe(toTopic: "test"){ error in
            print("subscribed",error)
        }
        Messaging.messaging().subscribe(toTopic: "test-ios"){ error in
            print("subscribed",error)
        }
        #else
